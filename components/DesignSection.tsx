...
const projects = [
  ...
  },
  {
    ...
    year: "2025",
    image: "data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSI4MDAiIGhlaWdodD0iNjAwIj48cmVjdCB3aWR0aD0iMTAwJSIgaGVpZ2h0PSIxMDAlIiBmaWxsPSIjZjNmNGY2Ii8+PC9zdmc+",
    bannerImage: "data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSI4MDAiIGhlaWdodD0iMjAwIj48cmVjdCB3aWR0aD0iMTAwJSIgaGVpZ2h0PSIxMDAlIiBmaWxsPSIjZjNmNGY2Ii8+PC9zdmc+",
    description: "A Jenga-based data physicalization that makes the fashion industry's ongoing water consumption visible, turning everyday clothing behaviors into a game of structural balance and collective collapse.",
    descriptionJP: "A Jenga-based data physicalization that makes the fashion industry's ongoing water consumption visible, turning everyday clothing behaviors into a game of structural balance and collective collapse.",
    ...
    shortIntroJP: "A Jenga-based data physicalization that makes the fashion industry's ongoing water consumption visible, turning everyday clothing behaviors into a game of structural balance and collective collapse.",
    ...
    longDescriptionJP: "Every year, the average person buys around 20 new clothing items, discards 14, and keeps roughly 23 that are never worn. Behind each garment lies an enormous environmental cost, from thousands of liters of water to carbon emissions and textile waste. Yet these consequences unfold so far from our daily lives that they rarely feel connected to what we wear.",
    aspect: "aspect-[4/3]",
    type: "Interactive Game",
    typeJP: "インタラクティブゲーム",
    mapping: "Consumption to Collapse",
    mappingJP: "Consumption to Collapse",
    duration: "2 Weeks",
    durationJP: "2 Weeks",
    dataStrip: [
      { value: "6", valueJP: "6", label: "DICE-DRIVEN GAME BEHAVIORS", labelJP: "DICE-DRIVEN GAME BEHAVIORS" },
      { value: "3", valueJP: "3", label: "GARMENT TYPES ENCODED", labelJP: "GARMENT TYPES ENCODED" },
      { value: "3", valueJP: "3", label: "CLOTHING STATUSES IN PLAY", labelJP: "CLOTHING STATUSES IN PLAY" },
      { value: "4", valueJP: "4", label: "DAILY CLOTHING ACTIONS MAPPED TO DICE", labelJP: "DAILY CLOTHING ACTIONS MAPPED TO DICE" }
    ],
    concept: {
      headline: "When consumption\ntopples the tower",
      headlineJP: "When consumption\ntopples the tower",
      body: [
        "Every year, the average person buys around 20 new clothing items, discards 14, and keeps roughly 23 that are never worn. Behind each garment lies an enormous environmental cost, from thousands of liters of water to carbon emissions and textile waste. Yet these consequences unfold so far from our daily lives that they rarely feel connected to what we wear.",
    ...
    designDimensions: {
      ...
      introJP: "The game was developed across four interlocking dimensions: the sustainability data that grounds it, the physical blocks that encode it, the dice-driven interaction that brings it to life, and the player sessions that put it to the test.",
      items: [
        { title: "Data", titleJP: "Data", body: "The design draws on sustainable fashion data from the Japanese Ministry of the Environment and open research sources. Three garment types were selected based on Japanese clothing ownership patterns: T-shirts, sweaters, and jeans. Each carries a distinct water footprint: approximately 2,700 liters for a T-shirt, 3,350 liters for a sweater, and up to 10,000 liters for a pair of jeans. Behavioral data further grounds the system: the average person purchases around 20 items per year, discards 14, and holds 23 as dead stock. Of discarded clothing, 59% is incinerated or landfilled, 24% recycled, and 18% reused.", bodyJP: "The design draws on sustainable fashion data from the Japanese Ministry of the Environment and open research sources. Three garment types were selected based on Japanese clothing ownership patterns: T-shirts, sweaters, and jeans. Each carries a distinct water footprint: approximately 2,700 liters for a T-shirt, 3,350 liters for a sweater, and up to 10,000 liters for a pair of jeans. Behavioral data further grounds the system: the average person purchases around 20 items per year, discards 14, and holds 23 as dead stock. Of discarded clothing, 59% is incinerated or landfilled, 24% recycled, and 18% reused." },
        { title: "Physicalization", titleJP: "Physicalization", body: "The tower is divided into two vertical zones. The lower foundation consists of blue blocks representing finite water resources. Above it sit clothing blocks in three statuses: grey for garments actively worn, transparent for dead stock never used, and white for new garments available on the \"market,\" placed outside the tower at the start. The water cost of each garment type is encoded in block ratios: buying a T-shirt removes one water block, a sweater removes two, and jeans removes three. White cylindrical inserts represent recycled material; they can fill empty foundation spaces to stabilize the structure, but remain visually and materially distinct from the original water blocks, reflecting that recycling supports the system without truly restoring what was consumed.", bodyJP: "The tower is divided into two vertical zones. The lower foundation consists of blue blocks representing finite water resources. Above it sit clothing blocks in three statuses: grey for garments actively worn, transparent for dead stock never used, and white for new garments available on the \"market,\" placed outside the tower at the start. The water cost of each garment type is encoded in block ratios: buying a T-shirt removes one water block, a sweater removes two, and jeans removes three. White cylindrical inserts represent recycled material; they can fill empty foundation spaces to stabilize the structure, but remain visually and materially distinct from the original water blocks, reflecting that recycling supports the system without truly restoring what was consumed." },
        { title: "Interaction", titleJP: "Interaction", body: "A six-sided die governs each turn, with six possible outcomes: buy a T-shirt, buy a sweater, buy jeans, discard, recycle, or reuse. Buying places a new clothing block on top of the tower while extracting water blocks from the foundation. Discarding removes any clothing block to a visible waste zone. Recycling moves a clothing block to a recycle zone and inserts a cylinder into the foundation. Reusing means passing the turn entirely, reframing inaction as a deliberate strategy for maintaining balance. Water blocks removed during play are kept in front of each player, making every individual's cumulative water footprint visible throughout the game. A recording sheet tracks each player's decisions for post-game reflection.", bodyJP: "A six-sided die governs each turn, with six possible outcomes: buy a T-shirt, buy a sweater, buy jeans, discard, recycle, or reuse. Buying places a new clothing block on top of the tower while extracting water blocks from the foundation. Discarding removes any clothing block to a visible waste zone. Recycling moves a clothing block to a recycle zone and inserts a cylinder into the foundation. Reusing means passing the turn entirely, reframing inaction as a deliberate strategy for maintaining balance. Water blocks removed during play are kept in front of each player, making every individual's cumulative water footprint visible throughout the game. A recording sheet tracks each player's decisions for post-game reflection." },
